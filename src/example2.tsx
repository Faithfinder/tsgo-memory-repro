// Committed headline file 2 of 8. Each file independently exercises the full Panda
...
export function Panel2({ tone, size }: { tone?: "primary" | "ghost"; size?: "sm" | "lg" }) {
  const cls = css({
  ...
  return (
    <Box2 className={cls} data-tone={tone}>
      <div className={stack({ gap: "2", direction: "column" })}>
        <span className={recipe2({ tone, size })}>label 2</span>
