// Committed headline file 1 of 8. Each file independently exercises the full Panda
...
export function Panel1({ tone, size }: { tone?: "primary" | "ghost"; size?: "sm" | "lg" }) {
  const cls = css({
  ...
  return (
    <Box1 className={cls} data-tone={tone}>
      <div className={stack({ gap: "2", direction: "column" })}>
        <span className={recipe1({ tone, size })}>label 1</span>
