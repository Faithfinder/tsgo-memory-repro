// Committed headline file 7 of 8. Each file independently exercises the full Panda
...
export function Panel7({ tone, size }: { tone?: "primary" | "ghost"; size?: "sm" | "lg" }) {
  const cls = css({
  ...
  return (
    <Box7 className={cls} data-tone={tone}>
      <div className={stack({ gap: "2", direction: "column" })}>
        <span className={recipe7({ tone, size })}>label 7</span>
