// Committed headline file 5 of 8. Each file independently exercises the full Panda
...
export function Panel5({ tone, size }: { tone?: "primary" | "ghost"; size?: "sm" | "lg" }) {
  const cls = css({
  ...
  return (
    <Box5 className={cls} data-tone={tone}>
      <div className={stack({ gap: "2", direction: "column" })}>
        <span className={recipe5({ tone, size })}>label 5</span>
