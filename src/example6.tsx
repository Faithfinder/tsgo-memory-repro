// Committed headline file 6 of 8. Each file independently exercises the full Panda
...
export function Panel6({ tone, size }: { tone?: "primary" | "ghost"; size?: "sm" | "lg" }) {
  const cls = css({
  ...
  return (
    <Box6 className={cls} data-tone={tone}>
      <div className={stack({ gap: "2", direction: "column" })}>
        <span className={recipe6({ tone, size })}>label 6</span>
