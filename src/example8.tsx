// Committed headline file 8 of 8. Each file independently exercises the full Panda
...
export function Panel8({ tone, size }: { tone?: "primary" | "ghost"; size?: "sm" | "lg" }) {
  const cls = css({
  ...
  return (
    <Box8 className={cls} data-tone={tone}>
      <div className={stack({ gap: "2", direction: "column" })}>
        <span className={recipe8({ tone, size })}>label 8</span>
