// Committed headline file 4 of 8. Each file independently exercises the full Panda
...
export function Panel4({ tone, size }: { tone?: "primary" | "ghost"; size?: "sm" | "lg" }) {
  const cls = css({
  ...
  return (
    <Box4 className={cls} data-tone={tone}>
      <div className={stack({ gap: "2", direction: "column" })}>
        <span className={recipe4({ tone, size })}>label 4</span>
